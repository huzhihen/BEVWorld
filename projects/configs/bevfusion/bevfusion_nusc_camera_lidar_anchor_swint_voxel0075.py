"""
BEVFusion nuScenes Camera + LiDAR 融合 Anchor3DHead 配置（Swin-T, voxel 0.075）。

训练::

    bash tools/dist_train.sh \\
      projects/configs/bevfusion/bevfusion_nusc_camera_lidar_anchor_swint_voxel0075.py 8 \\
      --work-dir work_dirs/bevfusion_camera_lidar_anchor_v0075 \\
...
# Anchor3DHead 使用 7 维框，需关闭 GT 速度维
data = dict(
